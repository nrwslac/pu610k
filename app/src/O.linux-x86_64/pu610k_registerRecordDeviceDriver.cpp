...
/* Generated from ../O.Common/pu610k.dbd */
...
epicsShareExtern void (*pvar_func_register_func_PU610KTimeInit)(void);
epicsShareExtern void (*pvar_func_register_func_PU610KTimeParse)(void);
epicsShareExtern void (*pvar_func_register_func_PU610KErrorInit)(void);
epicsShareExtern void (*pvar_func_register_func_PU610KErrorParse)(void);
...
epicsShareExtern int *pvar_int_save_restoreLogMissingRecords;
...
static struct iocshVarDef vardefs[] = {
	...
	{"save_restoreLogMissingRecords", iocshArgInt, (void * const)pvar_int_save_restoreLogMissingRecords},
...
int pu610k_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/reg/g/pcds/epics-dev/nrw/iocs/pu610k";
    ...
    (*pvar_func_register_func_PU610KTimeInit)();
    (*pvar_func_register_func_PU610KTimeParse)();
    (*pvar_func_register_func_PU610KErrorInit)();
    (*pvar_func_register_func_PU610KErrorParse)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"pu610k_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    pu610k_registerRecordDeviceDriver(*iocshPpdbbase);
}
